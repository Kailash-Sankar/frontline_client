        ...
        const getCovidData = async () => {
            ...
            try{
                ...
                data.data.statewise.forEach(element => {
                    if (element.state && (element.state == "Total" || element.state =="Karnataka") ){
                        element.title = element.state == 'Total' ?  'INDIA COVID-19': 'KARNATAKA COVID-19';
            ...
            <Row>
                ...
                <Row>
                    ...
                    <Col lg={9} md={9} sm={24} xs={24} >
                        <span className="header-text hashtag-1">#karnatakafightscovid19</span></Col>
