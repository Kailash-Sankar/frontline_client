...
import {ImageCarousel, PortalAppeals, Statistics} from '@components/HomeLayout';
        ...
        <Row style={{ 
            ...
            <Row>
                ...
                <Row>
                    ...
                    <Col lg={6} md={6} sm={12} xs={12} className="header-text hashtag-1">#fightcovid19</Col>
            ...
            <Col lg={6} sm={24} xs={24} md={6} className="gutter-row right-conteiner" >
                ...
                <Row style={{padding: "5px"}}>
                    <Col span="24">
                        <PortalAppeals appealsData={appeals} 
            ...
            <Col span={24}>
                <Row>
                  <Col lg={8} sm={24} xs={24} className="bottom-btn-containers">
                    <span className="goto-text">DONATE FUNDS <ArrowRightOutlined/></span><br/>
                    {"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."}
                  </Col>
                  <Col lg={8} sm={24} xs={24} className="bottom-btn-containers2">
                    <span className="goto-text">SUPPORT IN KIND <ArrowRightOutlined/></span><br/>
                    {"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."}
                  </Col>
                  <Col lg={8} sm={24} xs={24} className="bottom-btn-containers">
                     <Link to="/volunteer">
                       <span className="goto-text">VOLUNTEER <ArrowRightOutlined/></span><br/>
                       {"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."}
                      </Link>
                  </Col>
                </Row>
