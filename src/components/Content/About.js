...
const About = () => (
  <Wrapper>
    <div>
      ...
      <p>
        How can we build a platform that can get response and relief to anyone
        in their hour of need &ndash; respectfully, with dignity, and in the
      ...
      <p>
        ...
        non-profits, and groups working with migrant workers and the unorganised
        sector.
      </p>
      <p>
      ...
      <p>
        ...
        society organisations, non-governmental organisations, private sector
        and volunteer groups have all been channelled and coordinated through
        this platform.
      </p>
      <p>
        Sankalpa is a tribute to the tremendous creative energies and deep civic
        engagement of Bengaluru and Karnataka.
      </p>
      <h3>
      ...
      <div>
        <img
          ...
          alt="Spykk Labs"
        />
        <img src={sapLogo} style={{ width: 92, height: 48 }} alt="SAP Labs" />
      </div>
      ...
      <p>
        We acknowledge fruitful conversations with Whitefield Rising and LibTech
      </p>
      <h3>
        <strong>The Committee</strong>
      </h3>
      <p>
        Committee to Coordinate with CSOs/NGOs, Private Sector and International
        Organisations for Covid-19 Response-Related Activities
      </p>
      <p>Mahendra Jain, ACS Energy &ndash; Chair</p>
      <p>Uma Mahadevan, Principal Secretary, Panchayat Raj &ndash; Member</p>
      <p>Gunjan Krishna, Commissioner, Industrial Development &ndash; Member</p>
      <h3>
        <strong>The Working Group</strong>
      </h3>
      <p>
        Priyanka Mary Francis, Commissioner, Panchayat Raj and Additional Chief
        Electoral Officer
      </p>
      ...
      <h4>UNICEF and UNDP team members:</h4>
      <p>Manohar &amp; Peer Mohammed</p>
      <p>Manasa</p>
      <h4>Control Room Team:</h4>
      <p>
        Siddhant, Shubham, Lynda, Leena, Tarun, Tejas, Goutam, Aamir, Deeksha,
        Vignesh, Pannagashree, Arun
      </p>
    </div>
  </Wrapper>
);
